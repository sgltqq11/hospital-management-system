package com.sgl.hospital.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.sgl.hospital.mapper.HospitalSetMapper;
import com.sgl.hospital.mapper.ScheduleMapper;
import com.sgl.hospital.model.HospitalSet;
import com.sgl.hospital.model.Schedule;
import com.sgl.hospital.service.ApiService;
import com.sgl.hospital.util.BeanUtils;
import com.sgl.hospital.util.HttpRequestHelper;
import com.sgl.hospital.util.HmsException;
import com.sgl.hospital.util.MD5;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        ...
        if(null != respone && 200 == respone.getIntValue("code")) {
            ...
            throw new HmsException(respone.getString("message"), 201);
        }
    }
